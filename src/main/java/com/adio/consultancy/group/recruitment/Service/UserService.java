...
import com.adio.consultancy.group.recruitment.exception.AuthenticationException;
import com.adio.consultancy.group.recruitment.exception.ConflictException;
...
import com.adio.consultancy.group.recruitment.repository.TokenRepository;
import com.adio.consultancy.group.recruitment.repository.UserRepository;
...
public class UserService {
    ...
    private void prepareUserForSave(User user) throws Exception {
        normalizePhone(user);
    }
    ...
    private void prepareUserForCreation(User user) throws Exception {
    ...
    private void normalizePhone(User user) throws Exception {
